...
View a list of all added meals

See total calories per day

Navigate between multiple pages (Home, About, Features, Contact, Tracker page)

Responsive UI for both desktop and mobile devices

The app demonstrates key concepts of React including:
